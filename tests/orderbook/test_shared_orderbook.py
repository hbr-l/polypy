...
def test_orderbook_properties():
    ...
    assert book.market_id is None
    assert book.neg_risk is None
    assert book.min_order_size is None

    book.market_id = "0x123456"
    book.neg_risk = True
    book.min_order_size = 12

    assert book.market_id == "0x123456"
    assert book.neg_risk is True
    assert book.min_order_size == 12
...
def test_orderbook_marketable_amount_buy(book_t0_ws_msg_hashed):
    orderbook = SharedOrderBook(book_t0_ws_msg_hashed.asset_id, 0.001, True)
    orderbook = message_to_orderbook(book_t0_ws_msg_hashed, orderbook)
...
def test_orderbook_marketable_amount_raises_unknown_max_liquidity(
    ...
    orderbook = SharedOrderBook(
        ...
        0.001,
        True,
        shm_tick_size="unknown_max_liquidity_1",
        shm_lock="unknown_max_liquidity_2",
        shm_args="unknown_max_liquidity_3",
        shm_bid_q="unknown_max_liquidity_4",
        shm_ask_p="unknown_max_liquidity_5",
        shm_bid_p="unknown_max_liquidity_6",
        shm_ask_q="unknown_max_liquidity_7",
    )
    orderbook = message_to_orderbook(book_t0_ws_msg_hashed, orderbook)
...
def test_orderbook_midpoint_price(book_t0_ws_msg_hashed):
    ...
    orderbook = SharedOrderBook(
        ...
        0.001,
        True,
        shm_tick_size="midpoint_price_1",
        shm_lock="midpoint_price_2",
        shm_args="midpoint_price_3",
        shm_bid_q="midpoint_price_4",
        shm_ask_p="midpoint_price_5",
        shm_bid_p="midpoint_price_6",
        shm_ask_q="midpoint_price_7",
    )
    orderbook = message_to_orderbook(book_t0_ws_msg_hashed, orderbook)

    assert orderbook.midpoint_price == dec(0.335)
...
def test_orderbook_best_bid_raises_no_bids():
    orderbook = SharedOrderBook(
        ...
        0.01,
        True,
        shm_tick_size="best_bid_raises_no_bids_1",
        shm_lock="best_bid_raises_no_bids_2",
        shm_args="best_bid_raises_no_bids_3",
        shm_bid_q="best_bid_raises_no_bids_4",
        shm_ask_p="best_bid_raises_no_bids_5",
        shm_bid_p="best_bid_raises_no_bids_6",
        shm_ask_q="best_bid_raises_no_bids_7",
    )
    ...
    assert orderbook.best_ask_price == Decimal("0.4")
    assert orderbook.best_ask_size == Decimal("3")
...
def test_orderbook_best_ask_raises_no_asks():
    orderbook = SharedOrderBook(
        ...
        0.01,
        True,
        shm_tick_size="best_ask_raises_no_asks_1",
        shm_lock="best_ask_raises_no_asks_2",
        shm_args="best_ask_raises_no_asks_3",
        shm_bid_q="best_ask_raises_no_asks_4",
        shm_ask_p="best_ask_raises_no_asks_5",
        shm_bid_p="best_ask_raises_no_asks_6",
        shm_ask_q="best_ask_raises_no_asks_7",
    )
    ...
    assert orderbook.best_bid_price == Decimal("0.5")
    assert orderbook.best_bid_size == Decimal("2")
...
def test_orderbook_midpoint_no_bids():
    orderbook = SharedOrderBook(
        ...
        0.01,
        True,
        shm_tick_size="midpoint_no_bids_1",
        shm_lock="midpoint_no_bids_2",
        shm_args="midpoint_no_bids_3",
        shm_bid_q="midpoint_no_bids_4",
        shm_ask_p="midpoint_no_bids_5",
        shm_bid_p="midpoint_no_bids_6",
        shm_ask_q="midpoint_no_bids_7",
    )
    orderbook.set_asks([0.5, 0.4], [2, 3])

    assert orderbook.midpoint_price == Decimal("0.2")
...
def test_orderbook_midpoint_no_asks():
    orderbook = SharedOrderBook(
        ...
        0.01,
        True,
        shm_tick_size="midpoint_no_asks_1",
        shm_lock="midpoint_no_asks_2",
        shm_args="midpoint_no_asks_3",
        shm_bid_q="midpoint_no_asks_4",
        shm_ask_p="midpoint_no_asks_5",
        shm_bid_p="midpoint_no_asks_6",
        shm_ask_q="midpoint_no_asks_7",
    )
    orderbook.set_bids([0.5, 0.4], [2, 3])

    assert orderbook.midpoint_price == Decimal("0.75")
...
def test_message_to_orderbook_raise_empty_price_change_msg(
    ...
    book = SharedOrderBook(
        ...
        0.01,
        True,
        shm_tick_size="empty_price_change_msg_1",
        shm_lock="empty_price_change_msg_2",
        shm_args="empty_price_change_msg_3",
        shm_bid_q="empty_price_change_msg_4",
        shm_ask_p="empty_price_change_msg_5",
        shm_bid_p="empty_price_change_msg_6",
        shm_ask_q="empty_price_change_msg_7",
    )
    book = message_to_orderbook(book_t0_ws_msg_hashed, book)
...
def test_message_to_orderbook_raise_specify_event_type(book_t0_ws_msg_hashed):
    ...
    book = SharedOrderBook(book_t0_ws_msg_hashed.asset_id, 0.01, False)
    ...
    with pytest.raises(OrderBookException):
        message_to_orderbook(
            ...
            SharedOrderBook(
                ...
                0.01,
                True,
                shm_tick_size="raise_asset_id_1",
                shm_lock="raise_asset_id_2",
                shm_args="raise_asset_id_3",
                shm_bid_q="raise_asset_id_4",
                shm_ask_p="raise_asset_id_5",
                shm_bid_p="raise_asset_id_6",
                shm_ask_q="raise_asset_id_7",
            ),
        )
